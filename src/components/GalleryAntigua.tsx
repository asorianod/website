        ...
        >
          ...
          >
            ...
            <button
              ...
              className="absolute bottom-4 left-1/2 -translate-x-1/2 transform rounded-2xl bg-white px-4 py-2 text-sm text-black opacity-40 transition-opacity hover:opacity-60"
            >
              Descargar
            </button>
          </div>
